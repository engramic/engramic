...
user_prompt_type: reference (A reference type is an article, paragraph, data, that the user is asking me to understand as a reference) | tool (the user is asking you to use a tool on something )
