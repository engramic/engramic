...
class PromptGenIndices(Prompt):
    ...
    % if len(meta_list)>0:
    The domain_knowledge gives you insight into knowledge stored in your long term memory. It's here because it's the most closely related information you have stored about the user_prompt. Generate as many indicies as needed based on the user_prompt.
    % endif
