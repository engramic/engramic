...
class Service(ABC):
    class Topic(Enum):
        ...
        DOCUMENT_SCAN_DOCUMENT = 'document_scan_document'
        CODIFY_RESPONSE = 'codify_response'
        ENGRAM_REQUEST = 'engram_request'
        ENGRAM_RESULT = 'engram_result'
        PROGRESS_PROGRESS_UPDATED = 'progress_progress_updated'
        REPO_DIRECTORY_SCANNED = 'repo_directory_scanned'
        REPO_FILE_FOUND = 'repo_file_found'
        REPO_FILE_FOLDER_TREE_UPDATED = 'repo_file_folder_tree_updated'
